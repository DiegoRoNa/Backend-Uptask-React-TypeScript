...
router.put('/:projectId', 
    hasAuthorization,
    param('projectId').isInt().withMessage('ID no válido'),
    body('projectName').notEmpty().withMessage('El nombre del proyecto es obligatorio'),
    body('clientName').notEmpty().withMessage('El nombre del cliente es obligatorio'),
    body('description').notEmpty().withMessage('La descripción es obligatoria'),
    handleInputErrors,
...
router.get('/:projectId/tasks/:taskId', 
    param('taskId').isInt().withMessage('Id no válido'),
    handleInputErrors,
...
router.post('/:projectId/team', 
    body('id').isInt().withMessage('Id no válido'),
    handleInputErrors,
    TeamMemberController.addMemberById
)

router.delete('/:projectId/team/:userId', 
    param('userId').isInt().withMessage('Id no válido'),
    handleInputErrors,
...
router.delete('/:projectId/tasks/:taskId/notes/:noteId',
    param('noteId').isInt().withMessage('Id no válido'),
    handleInputErrors,
